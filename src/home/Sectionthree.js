...
function Sectionthree (){
    ...
    <div className="row p-5 ">
        ...
        <div className="col-lg-3 col-md-6 col-sm-6   text-center section-three-card mb-5">
            <img className="img-fluid mb-5" src={livingroom} alt=""/>
            <span >living roomm</span>
        </div>
        <div className="col-lg-3 col-md-6 col-sm-6   text-center section-three-card mb-5">
            <img className="img-fluid mb-5" src={diningroom} alt=""/>
            <span >dining room</span>
        </div>
        <div className="col-lg-3 col-md-6 col-sm-6  text-center section-three-card mb-5">
            <img className="img-fluid mb-5" src={accessories} alt=""/>
        ...
        <div className="col-lg-3 col-md-6 col-sm-6  text-center section-three-card mb-5">
            <img className="img-fluid mb-5" src={antiqueclocks} alt=""/>
